...
void testBasicOperations() {
    ...
    ListDG<char> graph(vertices, 4, edges, 4);
...
void testTopologicalSort() {
    ...
    // Test case 1: DAG
    {
        ...
        ListDG<char> dag(vertices, 4, edges, 4);
    ...
    // Test case 2: Graph with cycle
    {
        ...
        ListDG<char> cyclic(vertices, 3, edges, 3);
...
void testErrorHandling() {
    ...
    try {
        ListDG<char> graph(vertices, 2, edges, 1);
        assert(false && "Should throw exception for invalid vertex");
    } catch (const std::invalid_argument&) {
        // Expected exception
    }

    ListDG<char> graph(vertices, 2, edges, 0);
...
void testDisconnectedGraph() {
    ...
    ListDG<char> graph(vertices, 4, edges, 2);
